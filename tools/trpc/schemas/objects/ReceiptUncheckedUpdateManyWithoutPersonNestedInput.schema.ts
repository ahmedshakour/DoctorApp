...
const Schema: z.ZodType<Prisma.ReceiptUncheckedUpdateManyWithoutPersonNestedInput> =
  z.union([
    z
      .object({
        create: z
...
export const ReceiptUncheckedUpdateManyWithoutPersonNestedInputObjectSchema =
  Schema;
