...
const Schema: z.ZodType<Prisma.ReceiptUpdateManyWithWhereWithoutPersonInput> = z
  .object({
...
export const ReceiptUpdateManyWithWhereWithoutPersonInputObjectSchema = Schema;
