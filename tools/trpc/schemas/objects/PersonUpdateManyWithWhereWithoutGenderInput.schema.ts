...
const Schema: z.ZodType<Prisma.PersonUpdateManyWithWhereWithoutGenderInput> = z
  .object({
...
export const PersonUpdateManyWithWhereWithoutGenderInputObjectSchema = Schema;
