...
const Schema: z.ZodType<Prisma.PersonUncheckedUpdateManyWithoutGenderNestedInput> =
  z.union([
    z
      .object({
        create: z
...
export const PersonUncheckedUpdateManyWithoutGenderNestedInputObjectSchema =
  Schema;
