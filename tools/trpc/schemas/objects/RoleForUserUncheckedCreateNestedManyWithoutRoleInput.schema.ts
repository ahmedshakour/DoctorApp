...
const Schema: z.ZodType<Prisma.RoleForUserUncheckedCreateNestedManyWithoutRoleInput> =
  z.union([
    z
      .object({
        create: z
...
export const RoleForUserUncheckedCreateNestedManyWithoutRoleInputObjectSchema =
  Schema;
