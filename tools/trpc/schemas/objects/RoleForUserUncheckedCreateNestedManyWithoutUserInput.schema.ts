...
const Schema: z.ZodType<Prisma.RoleForUserUncheckedCreateNestedManyWithoutUserInput> =
  z.union([
    z
      .object({
        create: z
...
export const RoleForUserUncheckedCreateNestedManyWithoutUserInputObjectSchema =
  Schema;
