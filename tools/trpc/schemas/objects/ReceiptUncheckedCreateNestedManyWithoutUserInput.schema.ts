...
const Schema: z.ZodType<Prisma.ReceiptUncheckedCreateNestedManyWithoutUserInput> =
  z.union([
    z
      .object({
        create: z
...
export const ReceiptUncheckedCreateNestedManyWithoutUserInputObjectSchema =
  Schema;
